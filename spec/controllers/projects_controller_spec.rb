...
RSpec.describe ProjectsController, type: :controller do
  ...
  let(:valid_attributes) {
    FactoryBot.build(:project, user: nil).attributes
  }
  ...
  describe "POST #create" do
    ...
    context "with valid params" do
      ...
      it "Creates a new Project owned by current user" do
        post :create, params: {project: valid_attributes}, session: valid_session
  ...
  describe "PUT #update" do
    ...
    context "with valid params" do
      let(:new_attributes) {
        FactoryBot.build(:project, user: @user).attributes
      }
  ...
  describe "DELETE #destroy" do
    ...
    it "does not destroy project owned by different user" do
      @user = FactoryBot.create(:user)
      expect {
        delete :destroy, params: {id: @project.to_param}, session: valid_session
      }.to_not change(Project, :count)
